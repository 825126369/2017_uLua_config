...
boost::unordered_map<int, LandlordNetHuman_SoundCFGData>& LandlordNetHuman_SoundCFG::GetMapData()
{
	return mMapData;
}
...
{
	std::ifstream readStream("../Config/LandlordNetHuman_SoundCFG.xml", std::ios::binary);
