LandlordNetHuman_MultiLanguageCFG = {}

function LandlordNetHuman_MultiLanguageCFG:getData(key)
...
function LandlordNetHuman_MultiLanguageCFG:init()
	self.datas = {}
...
LandlordNetHuman_MultiLanguageCFG:init()
