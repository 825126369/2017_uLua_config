...
E_SERVER_MSG_TYPE_E_MST_L2C_ENTER_ROOM_ENUM.index = 6
...
E_SERVER_MSG_TYPE_E_MST_L2C_GET_ROOM_SCENE_INFO_ENUM.index = 7
...
E_SERVER_MSG_TYPE_E_MST_L2C_CHECK_STATE_ENUM.index = 8
...
E_SERVER_MSG_TYPE_E_MST_L2C_LEAVE_ROOM_ENUM.index = 9
...
E_SERVER_MSG_TYPE.values = {E_SERVER_MSG_TYPE_E_MST_START_C2L_ENUM,E_SERVER_MSG_TYPE_E_MST_C2L_ENTER_ROOM_ENUM,E_SERVER_MSG_TYPE_E_MST_C2L_GET_ROOM_SCENE_INFO_ENUM,E_SERVER_MSG_TYPE_E_MST_C2L_CHECK_STATE_ENUM,E_SERVER_MSG_TYPE_E_MST_C2L_LEAVE_ROOM_ENUM,E_SERVER_MSG_TYPE_E_MST_START_L2C_ENUM,E_SERVER_MSG_TYPE_E_MST_L2C_ENTER_ROOM_ENUM,E_SERVER_MSG_TYPE_E_MST_L2C_GET_ROOM_SCENE_INFO_ENUM,E_SERVER_MSG_TYPE_E_MST_L2C_CHECK_STATE_ENUM,E_SERVER_MSG_TYPE_E_MST_L2C_LEAVE_ROOM_ENUM,E_SERVER_MSG_TYPE_E_MST_L2C_START_GAME_ENUM,E_SERVER_MSG_TYPE_E_MST_CLEND_INDEX_ENUM}
...
E_GAME_STATE_E_GAME_STATE_ROBLANDLORE_ENUM.index = 3
E_GAME_STATE_E_GAME_STATE_ROBLANDLORE_ENUM.number = 3
E_GAME_STATE_E_GAME_STATE_PLAYHAND_ENUM.name = "e_game_state_playhand"
E_GAME_STATE_E_GAME_STATE_PLAYHAND_ENUM.index = 4
E_GAME_STATE_E_GAME_STATE_PLAYHAND_ENUM.number = 4
E_GAME_STATE_E_GAME_STATE_AWARD_ENUM.name = "e_game_state_award"
E_GAME_STATE_E_GAME_STATE_AWARD_ENUM.index = 5
E_GAME_STATE_E_GAME_STATE_AWARD_ENUM.number = 5
E_GAME_STATE.name = "e_game_state"
E_GAME_STATE.full_name = ".game_landlord_protocol.e_game_state"
E_GAME_STATE.values = {E_GAME_STATE_E_GAME_STATE_NONE_ENUM,E_GAME_STATE_E_GAME_STATE_MATCHING_ENUM,E_GAME_STATE_E_GAME_STATE_STARTGAME_ENUM,E_GAME_STATE_E_GAME_STATE_ROBLANDLORE_ENUM,E_GAME_STATE_E_GAME_STATE_PLAYHAND_ENUM,E_GAME_STATE_E_GAME_STATE_AWARD_ENUM}
