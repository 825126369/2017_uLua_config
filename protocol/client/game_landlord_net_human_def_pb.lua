...
E_SERVER_MSG_TYPE_E_MST_C2L_CREATE_ROOM_ENUM = protobuf.EnumValueDescriptor();
E_SERVER_MSG_TYPE_E_MST_C2L_CHANGE_DESK_ENUM = protobuf.EnumValueDescriptor();
...
E_SERVER_MSG_TYPE_E_MST_L2C_CREATE_ROOM_ENUM = protobuf.EnumValueDescriptor();
E_SERVER_MSG_TYPE_E_MST_L2C_CHANGE_DESK_ENUM = protobuf.EnumValueDescriptor();
...
E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_WHO_IS_ROOMCREATOR_ENUM = protobuf.EnumValueDescriptor();
...
local ROOM_INFO_ROOMNAME_FIELD = protobuf.FieldDescriptor();
local ROOM_INFO_PLAYER_COUNT_FIELD = protobuf.FieldDescriptor();
local ROOM_INFO_ROOM_STATE_FIELD = protobuf.FieldDescriptor();
local ROOM_INFO_ORNEEDPASSWORD_FIELD = protobuf.FieldDescriptor();
local ROOM_INFO_ORSHUFFLE_FIELD = protobuf.FieldDescriptor();
local ROOM_INFO_PASSWORD_FIELD = protobuf.FieldDescriptor();
local ROOM_INFO_ROOM_CREATOR_FIELD = protobuf.FieldDescriptor();
...
local INVITATION_INFO_ROOMNAME_FIELD = protobuf.FieldDescriptor();
local INVITATION_INFO_COUNT_FIELD = protobuf.FieldDescriptor();
...
E_SERVER_MSG_TYPE_E_MST_C2L_ROOMLIST_ENUM.index = 9
...
E_SERVER_MSG_TYPE_E_MST_C2L_ADD_ROBOT_ENUM.index = 10
...
E_SERVER_MSG_TYPE_E_MST_C2L_KICH_PLAYER_ENUM.index = 11
...
E_SERVER_MSG_TYPE_E_MST_C2L_OR_PREPARE_ENUM.index = 12
...
E_SERVER_MSG_TYPE_E_MST_C2L_JOIN_PLAYER_LIST_ENUM.index = 13
...
E_SERVER_MSG_TYPE_E_MST_C2L_JOIN_ROOM_ENUM.index = 14
...
E_SERVER_MSG_TYPE_E_MST_C2L_OR_AGREE_JOIN_ROOM_ENUM.index = 15
E_SERVER_MSG_TYPE_E_MST_C2L_OR_AGREE_JOIN_ROOM_ENUM.number = 10016
E_SERVER_MSG_TYPE_E_MST_C2L_CREATE_ROOM_ENUM.name = "e_mst_c2l_create_room"
E_SERVER_MSG_TYPE_E_MST_C2L_CREATE_ROOM_ENUM.index = 16
E_SERVER_MSG_TYPE_E_MST_C2L_CREATE_ROOM_ENUM.number = 10017
E_SERVER_MSG_TYPE_E_MST_C2L_CHANGE_DESK_ENUM.name = "e_mst_c2l_change_desk"
E_SERVER_MSG_TYPE_E_MST_C2L_CHANGE_DESK_ENUM.index = 17
E_SERVER_MSG_TYPE_E_MST_C2L_CHANGE_DESK_ENUM.number = 10019
...
E_SERVER_MSG_TYPE_E_MST_L2C_ENTER_ROOM_ENUM.index = 19
...
E_SERVER_MSG_TYPE_E_MST_L2C_CHECK_STATE_ENUM.index = 21
...
E_SERVER_MSG_TYPE_E_MST_L2C_LEAVE_ROOM_ENUM.index = 22
...
E_SERVER_MSG_TYPE_E_MST_L2C_CREATE_ROOM_ENUM.name = "e_mst_l2c_create_room"
E_SERVER_MSG_TYPE_E_MST_L2C_CREATE_ROOM_ENUM.index = 30
E_SERVER_MSG_TYPE_E_MST_L2C_CREATE_ROOM_ENUM.number = 15013
E_SERVER_MSG_TYPE_E_MST_L2C_CHANGE_DESK_ENUM.name = "e_mst_l2c_change_desk"
E_SERVER_MSG_TYPE_E_MST_L2C_CHANGE_DESK_ENUM.index = 31
E_SERVER_MSG_TYPE_E_MST_L2C_CHANGE_DESK_ENUM.number = 15015
E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_STARTGAME_ENUM.name = "e_mst_l2c_notice_startgame"
E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_STARTGAME_ENUM.index = 32
...
E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_PLAYHAND_ENUM.index = 33
...
E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_ROB_LANDLORD_ENUM.index = 34
...
E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_WINLOSE_ENUM.index = 35
...
E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_ROB_LANDLORD_RESULT_ENUM.index = 36
...
E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_WHO_PLAYHAND_ENUM.index = 37
...
E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_SYSTEMTALK_ENUM.index = 38
...
E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_ROOM_ENTER_LEAVE_INFO_ENUM.index = 39
...
E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_ROOM_PREPARE_INFO_ENUM.index = 40
...
E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_ROOM_CHANGE_INFO_ENUM.index = 41
...
E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_INVITE_ROOM_LIST_ENUM.index = 42
E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_INVITE_ROOM_LIST_ENUM.number = 15111
E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_WHO_IS_ROOMCREATOR_ENUM.name = "e_mst_l2c_notice_who_is_roomcreator"
E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_WHO_IS_ROOMCREATOR_ENUM.index = 43
E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_WHO_IS_ROOMCREATOR_ENUM.number = 15112
...
E_SERVER_MSG_TYPE.values = {E_SERVER_MSG_TYPE_E_MST_START_C2L_ENUM,E_SERVER_MSG_TYPE_E_MST_C2L_ENTER_ROOM_ENUM,E_SERVER_MSG_TYPE_E_MST_C2L_GET_ROOM_SCENE_INFO_ENUM,E_SERVER_MSG_TYPE_E_MST_C2L_CHECK_STATE_ENUM,E_SERVER_MSG_TYPE_E_MST_C2L_LEAVE_ROOM_ENUM,E_SERVER_MSG_TYPE_E_MST_C2L_ROB_LANDLORD_ENUM,E_SERVER_MSG_TYPE_E_MST_C2L_PLAYHAND_ENUM,E_SERVER_MSG_TYPE_E_MST_C2L_HANG_ENUM,E_SERVER_MSG_TYPE_E_MST_C2L_SYSTEMTALK_ENUM,E_SERVER_MSG_TYPE_E_MST_C2L_ROOMLIST_ENUM,E_SERVER_MSG_TYPE_E_MST_C2L_ADD_ROBOT_ENUM,E_SERVER_MSG_TYPE_E_MST_C2L_KICH_PLAYER_ENUM,E_SERVER_MSG_TYPE_E_MST_C2L_OR_PREPARE_ENUM,E_SERVER_MSG_TYPE_E_MST_C2L_JOIN_PLAYER_LIST_ENUM,E_SERVER_MSG_TYPE_E_MST_C2L_JOIN_ROOM_ENUM,E_SERVER_MSG_TYPE_E_MST_C2L_OR_AGREE_JOIN_ROOM_ENUM,E_SERVER_MSG_TYPE_E_MST_C2L_CREATE_ROOM_ENUM,E_SERVER_MSG_TYPE_E_MST_C2L_CHANGE_DESK_ENUM,E_SERVER_MSG_TYPE_E_MST_START_L2C_ENUM,E_SERVER_MSG_TYPE_E_MST_L2C_ENTER_ROOM_ENUM,E_SERVER_MSG_TYPE_E_MST_L2C_GET_ROOM_SCENE_INFO_ENUM,E_SERVER_MSG_TYPE_E_MST_L2C_CHECK_STATE_ENUM,E_SERVER_MSG_TYPE_E_MST_L2C_LEAVE_ROOM_ENUM,E_SERVER_MSG_TYPE_E_MST_L2C_HANG_ENUM,E_SERVER_MSG_TYPE_E_MST_L2C_ROOMLIST_ENUM,E_SERVER_MSG_TYPE_E_MST_L2C_ADD_ROBOT_ENUM,E_SERVER_MSG_TYPE_E_MST_L2C_KICH_PLAYER_ENUM,E_SERVER_MSG_TYPE_E_MST_L2C_JOIN_PLAYER_LIST_RESULT_ENUM,E_SERVER_MSG_TYPE_E_MST_L2C_JOIN_ROOM_RESULT_ENUM,E_SERVER_MSG_TYPE_E_MST_L2C_OR_AGREE_JOIN_ROOM_RESULT_ENUM,E_SERVER_MSG_TYPE_E_MST_L2C_CREATE_ROOM_ENUM,E_SERVER_MSG_TYPE_E_MST_L2C_CHANGE_DESK_ENUM,E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_STARTGAME_ENUM,E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_PLAYHAND_ENUM,E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_ROB_LANDLORD_ENUM,E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_WINLOSE_ENUM,E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_ROB_LANDLORD_RESULT_ENUM,E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_WHO_PLAYHAND_ENUM,E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_SYSTEMTALK_ENUM,E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_ROOM_ENTER_LEAVE_INFO_ENUM,E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_ROOM_PREPARE_INFO_ENUM,E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_ROOM_CHANGE_INFO_ENUM,E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_INVITE_ROOM_LIST_ENUM,E_SERVER_MSG_TYPE_E_MST_L2C_NOTICE_WHO_IS_ROOMCREATOR_ENUM,E_SERVER_MSG_TYPE_E_MST_CLEND_INDEX_ENUM}
...
ROOM_INFO_ROOMNAME_FIELD.name = "roomName"
ROOM_INFO_ROOMNAME_FIELD.full_name = ".game_landlord_net_human_protocol.room_info.roomName"
ROOM_INFO_ROOMNAME_FIELD.number = 2
ROOM_INFO_ROOMNAME_FIELD.index = 1
ROOM_INFO_ROOMNAME_FIELD.label = 1
ROOM_INFO_ROOMNAME_FIELD.has_default_value = false
ROOM_INFO_ROOMNAME_FIELD.default_value = ""
ROOM_INFO_ROOMNAME_FIELD.type = 9
ROOM_INFO_ROOMNAME_FIELD.cpp_type = 9
...
ROOM_INFO_PLAYER_COUNT_FIELD.number = 3
ROOM_INFO_PLAYER_COUNT_FIELD.index = 2
...
ROOM_INFO_ROOM_STATE_FIELD.number = 4
ROOM_INFO_ROOM_STATE_FIELD.index = 3
...
ROOM_INFO_ORNEEDPASSWORD_FIELD.name = "orNeedPassword"
ROOM_INFO_ORNEEDPASSWORD_FIELD.full_name = ".game_landlord_net_human_protocol.room_info.orNeedPassword"
ROOM_INFO_ORNEEDPASSWORD_FIELD.number = 5
ROOM_INFO_ORNEEDPASSWORD_FIELD.index = 4
ROOM_INFO_ORNEEDPASSWORD_FIELD.label = 1
ROOM_INFO_ORNEEDPASSWORD_FIELD.has_default_value = false
ROOM_INFO_ORNEEDPASSWORD_FIELD.default_value = false
ROOM_INFO_ORNEEDPASSWORD_FIELD.type = 8
ROOM_INFO_ORNEEDPASSWORD_FIELD.cpp_type = 7

ROOM_INFO_ORSHUFFLE_FIELD.name = "orShuffle"
ROOM_INFO_ORSHUFFLE_FIELD.full_name = ".game_landlord_net_human_protocol.room_info.orShuffle"
ROOM_INFO_ORSHUFFLE_FIELD.number = 6
ROOM_INFO_ORSHUFFLE_FIELD.index = 5
ROOM_INFO_ORSHUFFLE_FIELD.label = 1
ROOM_INFO_ORSHUFFLE_FIELD.has_default_value = false
ROOM_INFO_ORSHUFFLE_FIELD.default_value = false
ROOM_INFO_ORSHUFFLE_FIELD.type = 8
ROOM_INFO_ORSHUFFLE_FIELD.cpp_type = 7

ROOM_INFO_PASSWORD_FIELD.name = "password"
ROOM_INFO_PASSWORD_FIELD.full_name = ".game_landlord_net_human_protocol.room_info.password"
ROOM_INFO_PASSWORD_FIELD.number = 7
ROOM_INFO_PASSWORD_FIELD.index = 6
ROOM_INFO_PASSWORD_FIELD.label = 1
ROOM_INFO_PASSWORD_FIELD.has_default_value = false
ROOM_INFO_PASSWORD_FIELD.default_value = ""
ROOM_INFO_PASSWORD_FIELD.type = 9
ROOM_INFO_PASSWORD_FIELD.cpp_type = 9

ROOM_INFO_ROOM_CREATOR_FIELD.name = "room_creator"
ROOM_INFO_ROOM_CREATOR_FIELD.full_name = ".game_landlord_net_human_protocol.room_info.room_creator"
ROOM_INFO_ROOM_CREATOR_FIELD.number = 8
ROOM_INFO_ROOM_CREATOR_FIELD.index = 7
ROOM_INFO_ROOM_CREATOR_FIELD.label = 1
ROOM_INFO_ROOM_CREATOR_FIELD.has_default_value = false
ROOM_INFO_ROOM_CREATOR_FIELD.default_value = 0
ROOM_INFO_ROOM_CREATOR_FIELD.type = 5
ROOM_INFO_ROOM_CREATOR_FIELD.cpp_type = 1
...
ROOM_INFO.fields = {ROOM_INFO_ROOM_ID_FIELD, ROOM_INFO_ROOMNAME_FIELD, ROOM_INFO_PLAYER_COUNT_FIELD, ROOM_INFO_ROOM_STATE_FIELD, ROOM_INFO_ORNEEDPASSWORD_FIELD, ROOM_INFO_ORSHUFFLE_FIELD, ROOM_INFO_PASSWORD_FIELD, ROOM_INFO_ROOM_CREATOR_FIELD}
...
INVITATION_INFO_ROOMNAME_FIELD.name = "roomName"
INVITATION_INFO_ROOMNAME_FIELD.full_name = ".game_landlord_net_human_protocol.invitation_info.roomName"
INVITATION_INFO_ROOMNAME_FIELD.number = 3
INVITATION_INFO_ROOMNAME_FIELD.index = 2
INVITATION_INFO_ROOMNAME_FIELD.label = 1
INVITATION_INFO_ROOMNAME_FIELD.has_default_value = false
INVITATION_INFO_ROOMNAME_FIELD.default_value = ""
INVITATION_INFO_ROOMNAME_FIELD.type = 9
INVITATION_INFO_ROOMNAME_FIELD.cpp_type = 9

INVITATION_INFO_COUNT_FIELD.name = "count"
INVITATION_INFO_COUNT_FIELD.full_name = ".game_landlord_net_human_protocol.invitation_info.count"
INVITATION_INFO_COUNT_FIELD.number = 4
INVITATION_INFO_COUNT_FIELD.index = 3
INVITATION_INFO_COUNT_FIELD.label = 1
INVITATION_INFO_COUNT_FIELD.has_default_value = false
INVITATION_INFO_COUNT_FIELD.default_value = 0
INVITATION_INFO_COUNT_FIELD.type = 5
INVITATION_INFO_COUNT_FIELD.cpp_type = 1
...
INVITATION_INFO.fields = {INVITATION_INFO_SENDERINFO_FIELD, INVITATION_INFO_ROOMID_FIELD, INVITATION_INFO_ROOMNAME_FIELD, INVITATION_INFO_COUNT_FIELD}
