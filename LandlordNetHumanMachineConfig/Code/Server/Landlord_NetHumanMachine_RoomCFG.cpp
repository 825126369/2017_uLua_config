...
boost::unordered_map<int, Landlord_NetHumanMachine_RoomCFGData>& Landlord_NetHumanMachine_RoomCFG::GetMapData()
{
	return mMapData;
}
...
{
	std::ifstream readStream("../Config/Landlord_NetHumanMachine_RoomCFG.xml", std::ios::binary);
