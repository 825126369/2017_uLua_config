...
boost::unordered_map<std::string, Landlord_MultiLanguageCFGData>& Landlord_MultiLanguageCFG::GetMapData()
{
	return mMapData;
}
...
{
	std::ifstream readStream("../Config/Landlord_MultiLanguageCFG.xml", std::ios::binary);
