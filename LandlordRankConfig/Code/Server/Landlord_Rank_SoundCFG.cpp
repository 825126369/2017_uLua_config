...
boost::unordered_map<int, Landlord_Rank_SoundCFGData>& Landlord_Rank_SoundCFG::GetMapData()
{
	return mMapData;
}
...
{
	std::ifstream readStream("../Config/Landlord_Rank_SoundCFG.xml", std::ios::binary);
