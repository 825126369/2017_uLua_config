Landlord_Rank_MultiLanguageCFG = {}

function Landlord_Rank_MultiLanguageCFG:getData(key)
...
function Landlord_Rank_MultiLanguageCFG:init()
	self.datas = {}
...
Landlord_Rank_MultiLanguageCFG:init()
